...
icon_path = "../../client/src/icons/earth.jpg"
icon_base64 = get_base64_of_bin_file(icon_path)


st.markdown("""
    <style>
        /* Reduce Streamlit's default padding at the top */
        .block-container {
            padding-top: 1.8rem;  /* default is ~6rem */
        }
        .header-bar {
            display: flex;
            align-items: center;
            padding: 1rem 1.5rem;
            background: rgba(0,0,0,0.0); /* Solid background */  
            border-radius: 12px;
