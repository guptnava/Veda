...
st.sidebar.header(" 🔌  Connection Details:")
host = st.sidebar.text_input("Host", "lnsah2u.uk.db.com")
port = st.sidebar.text_input("Port", "1700")
service = st.sidebar.text_input("Service", "lnsah2u_app.uk.db.com")
user = st.sidebar.text_input("User", "rfds_owner")
password = st.sidebar.text_input("Password", "owner_2018", type="password")
                    ...
                    if not q_list:
                        ...
                        with st.spinner("Generating synonyms..."):
                            ...
                            for training_id, question in questions_in_db:
                                ...
                                synonyms = generate_synonyms_bulk(question)  
                                #synonyms = None
    ...
    if st.button("View Questions and Synonyms"):
        ...
        if not conn:
            ...
            try:
                ...
                st.markdown("<h1 style='text-align: left; font-size: 1.2rem;'>Current Training Synonyms</h1>", unsafe_allow_html=True)
